/* =========================================================
   MADRASA SaaS — ENTERPRISE COMPLETE DATABASE (UPDATED)
...
-- ========================================================
-- MADRASA DIVISIONS (MULTI TENANT SUPPORT)
-- ========================================================
...
(5,'students','Students','ছাত্রসমূহ',2);
...
CREATE TABLE users (
  ...
  FOREIGN KEY (madrasa_id) 
    REFERENCES madrasas(id) 
    ON DELETE CASCADE,
